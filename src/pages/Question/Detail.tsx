...
// api
import { GetGoldPost } from "@api/community";
const Detail = () => {
  ...
  const commentArr = [1, 2, 3, 4, 5, 3, 3, 3, 3];
    ...
    <Div>
      ...
      <Container>
        <PostContainer>
          ...
          >
            챗쪽이는 내용 없음 챗쪽이는 내용 없음 챗쪽이는 내용 없음 챗쪽이는
            내용 없음 챗쪽이는 내용 없음 챗쪽이는 내용 없음 챗쪽이는 내용 없음
          </Text>
            ...
            <Comment>
              <div className="top-content-box">
                ...
                <div className="delete-icon">
                  <img src={deleteicon} width={9} height={11} />
                </div>
              </div>
              ...
              <div>
                <Text
                  ...
                  height="20px"
                >
                  보증금 할부 불가능 말이 되는 소리를 하세요.보증금 할부 불가능
                  말이 되는 소리를 하세요.보증금 할부 불가능 말이 되는 소리를
                  하세요.보증금 할부 불가능 말이 되는 소리를 하세요.보증금 할부
                  불가능 말이 되는 소리를 하세요.
                </Text>
